...
```bash
go install github.com/dinosn/leaklens/cmd/leaklens@latest
```

Accelerated install with Vectorscan/Hyperscan:

```bash
CGO_ENABLED=1 go install -tags vectorscan github.com/dinosn/leaklens/cmd/leaklens@latest
```
...
```bash
CGO_ENABLED=0 go install github.com/dinosn/leaklens/cmd/leaklens@latest
```
