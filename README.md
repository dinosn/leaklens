...
```bash
CGO_ENABLED=1 go install -tags vectorscan github.com/dinosn/leaklens/cmd/leaklens@v0.2.5
```
...
Tagged installs report the tag, such as `v0.2.5`. Main branch installs report `main@<commit>` instead of Go's raw pseudo-version.
