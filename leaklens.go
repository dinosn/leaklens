// Package leaklens provides a high-performance secrets detection library.
//
// LeakLens is a Go port of NoseyParker that can scan content for secrets
...
// Users can import just "github.com/dinosn/leaklens" without subpackages.
type (
...
//
//	// With custom rules
//	scanner, err := leaklens.NewScanner(leaklens.WithRules(myRules))
...
// Example:
//
//	rules, err := leaklens.LoadRulesFromFile("/path/to/rules.yaml")
//	if err != nil {
//	    return err
//	}
