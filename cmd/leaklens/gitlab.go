...
func init() {
	...
	gitlabScanCmd.Flags().StringVar(&gitlabOutputPath, "output", "leaklens.db", "Output database path")
	...
	gitlabCmd.Flags().StringVar(&gitlabOutputPath, "output", "leaklens.db", "Output database path")
