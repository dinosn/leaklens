...
func TestDiscoverNestedJSAssetURLsFindsWebpackRuntimeChunks(t *testing.T) {
	server := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		case "/static/js/main.b0f8bbd9.js":
			...
			fmt.Fprint(w, `n.p="/",n.u=e=>"static/js/"+e+"."+{196:"421c287f",257:"9a22e03f"}[e]+".chunk.js"`)
		case "/static/js/196.421c287f.chunk.js", "/static/js/257.9a22e03f.chunk.js":
			w.Header().Set("Content-Type", "application/javascript")
	...
	sort.Strings(got)
	want := []string{
		server.URL + "/static/js/196.421c287f.chunk.js",
		server.URL + "/static/js/257.9a22e03f.chunk.js",
	}
	sort.Strings(want)
